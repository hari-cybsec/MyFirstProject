				...
				<div class="row">
					<div class="col-lg-9 col-md-8 text-md-left text-center align-self-center">
						<?php if(get_theme_mod('supermart_ecommerce_sale_text') != '') {?>
							<p class="sale-text mb-md-0"><?php echo esc_html(get_theme_mod('supermart_ecommerce_sale_text', 'supermart-ecommerce')) ?></p>
						<?php }?>
					</div>
					<div class="col-lg-3 col-md-4 text-md-right text-center align-self-center">
						<?php if(get_theme_mod('supermart_ecommerce_shop_btn') != '') {?>
							<a class="shop-btn" href="<?php echo esc_url( get_permalink( get_option('woocommerce_shop_page_id') ) ); ?>"><?php echo esc_html(get_theme_mod('supermart_ecommerce_shop_btn', 'supermart-ecommerce')); ?><i class="fas fa-arrow-right"></i><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('supermart_ecommerce_shop_btn', 'supermart-ecommerce')); ?></span></a>
						<?php }?>
					</div>
				</div>
			</div>
						...
						if ( $count > 0 ){
						    foreach ( $supermart_ecommerce_product_categories as $supermart_ecommerce_product_category ) {
								...
								$supermart_ecommerce_child_args = array(
						  		...
						  		$supermart_ecommerce_child_product_cats = get_terms( $child_args );
